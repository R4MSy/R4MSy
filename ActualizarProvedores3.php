...
<div class="Titulo">
    ...
    mysqli_query($con,"UPDATE provedores
    SET Tipo='$Tipo', Id_Provedor='$Id_Provedor' WHERE Id_Provedor ='$Id_Provedor'");
    echo "<a href='ActualizarProvedores.php' target='_self'>Volver</a>";
    mysqli_close($con);
    ?>
