...
<div class="Titulo">
    ...
    <?php
        ...
        $clave=$_POST['id'];
        $resultado = mysqli_query($con,"select * from pedidos where Id_Cliente =
        $clave");
        if($resultado === FALSE)
        {
        echo "fallo ";
        ...
        echo"<center>";
        echo "<form action=ActualizarPedidos3.php method=POST>";
        echo "<h1>Editar Datos</h1>";
        echo "<table border='0'>";
        while($row=mysqli_fetch_array ($resultado))
        {
        echo"<tr>";
        echo "<td>Id_Cliente:</td>"; echo "<td><input type='int' name='Id_Cliente' value=".$row['Id_Cliente']."></td></tr>";
        echo "<tr>";
        echo "<td>TipoPedido:</td>"; echo "<td><input type='text' name='TipoPedido' value=".$row['TipoPedido']."></td></tr>";
        echo "<tr>";
        echo "<td>Cantidad:</td>"; echo "<td><input type='int' name='Cantidad' value=".$row['Cantidad']."></td></tr>";
        echo "<tr>";
        }
        echo "</table>";
        mysqli_close($con);
